...
function Auditeurs() {
    ...
    const modifyById = (id) => {
        const newSalutationID = prompt("Nouveau Salutation ID:");
        const newName = prompt("Nouveau prénom:");
        const newEmail = prompt("Nouvel adresse email:");
        const newFamilyName = prompt("Nouveau nom de famille:");
        const newTel = prompt("Nouveau tel:");
        const newLoginID = prompt("Nouveau Login ID:");
        const newPermissions = prompt("Nouveau permissions:");
        ...
        if (newName && newEmail) {
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    setFeedback(`Auditeur ${newName} created successfully.`);
                } else {
